...
parser.add_argument("-oheat", "--heating_rate_output", type=str, help="name of the file to store heating rates")
...
heating_rate_output = args.heating_rate_output 
...
while j < n_runs and i < n_runs_max:
    ...
    lightcone, run_id = p21c.run_lightcone_from_config(config_file, n_omp, random_seed, heating_rate_output = heating_rate_output)
